...
const DemoComputer=(props) => {
    ...
    // Add texture to the video inside the computer screen
    const txt = useVideoTexture(props.texture ? props.texture : '/textures/project/smallHero.mp4')

    // Add flip video to have video right side up
    useEffect(() => {
        if(txt) {
            txt.flipY = false;
        }
    ...
    // Add video based on current project shown
